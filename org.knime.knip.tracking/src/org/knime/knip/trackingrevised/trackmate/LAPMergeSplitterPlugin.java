 ...
 */
public class LAPMergeSplitterPlugin extends Plugin {
    // The shared instance.
    private static LAPMergeSplitterPlugin plugin;

    /**
     * The constructor.
     */
    public LAPMergeSplitterPlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static LAPMergeSplitterPlugin getDefault() {
        return plugin;
    }
