...
/**
 * This is the model implementation of HungarianOptimizer. Optimizes given
 * transitions in pairwise frames with the hungarian method to clear equal
 * situations.
 * 
 * @author Stephan Sellien
 */
public class HungarianOptimizerNodeModel extends NodeModel {

	/**
	 * Constructor for the node model.
	 */
	protected HungarianOptimizerNodeModel() {
		super(1, 1);
	}
