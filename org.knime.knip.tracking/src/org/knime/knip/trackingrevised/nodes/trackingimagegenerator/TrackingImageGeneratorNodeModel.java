package org.knime.knip.trackingrevised.nodes.trackingimagegenerator;
...
import org.knime.knip.trackingrevised.nodes.trackingimagegenerator.generator.TrackingImageGenerator;
...
public class TrackingImageGeneratorNodeModel extends NodeModel implements
	...
	protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
		...
		ImgPlus<UnsignedByteType> img = ImgPlus.wrap(tig.parse(m_code
				.getStringValue()));
		img.setAxis(new DefaultCalibratedAxis(Axes.TIME),
				img.numDimensions() - 1);
